...
const Reports = () => {
    ...
    const  {register,watch,formState:{errors},handleSubmit,control} =useForm({mode:"onBlur",defaultValues:{
      textareaControl:"",
    ...
    const disabled = Object.keys(errorsData).length > 0 
    ...
    const steps = [
      {
        title: 'تصنيف البلاغ',
        content: <ReportClassification title={title} handleSelected={handleSelected}   />,
      },
      {
        title: 'تفاصيل البلاغ',
        content:<ReportDetails errors={errors} handleSubmit={handleSubmit} register={register} watch={watch} control={control}  />,
      },
      {
