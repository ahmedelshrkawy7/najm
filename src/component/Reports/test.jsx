...
const Test = () => {
  ...
  return (
    <div className="mt-14 p-4">
      <div className="p-8 border border-gray-300 rounded-md  flex flex-col gap-6">
        ...
        {!!(values[9].files.length && values[9].images.length) && (
          <>
            ...
            <div className="border border-gray-300 py-1  rounded-lg px-10">
              <div className="">
                {!!photos.length && (
                        ...
                        {showImg && (
                          ...
                          >
                            <div className=" w-[600px]  relative ">
                              <div
                                className="absolute cursor-pointer  -top-6 -left-5 w-7 h-7 text-white bg-[#33835C] rounded-full font-semibold flex justify-center items-center z-50"
                                onClick={() => {
                                  setShowImg(false);
                                }}
                              >
                                <span className="-mt-[2px] text-[25px] ">
                                  &times;
                                </span>
                              </div>
                              <img
        ...
        <div className="border border-gray-300 rounded-lg  px-6">
